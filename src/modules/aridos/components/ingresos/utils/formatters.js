...
export function formatEntregaEstado(value = '') {
  switch (value) {
    case VENTA_ENTREGA_ESTADOS.ENTREGADA:
      return 'Entregada';
    case VENTA_ENTREGA_ESTADOS.NO_ENTREGADA:
      return 'No entregada';
    case VENTA_ENTREGA_ESTADOS.PENDIENTE:
      return 'Pendiente';
    default:
