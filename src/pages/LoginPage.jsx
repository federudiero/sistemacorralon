      ...
      <div className="auth-grid">
        <section className="auth-hero">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="auth-kpi"><div className="text-xs uppercase tracking-[0.14em] text-slate-400">Alta</div><div className="mt-2 text-lg font-semibold text-white">Registro separado</div><div className="mt-1 text-sm text-slate-300">Primero se crea el usuario y después se ingresa.</div></div>
          </div>
        </section>
        ...
        <section className="auth-card">
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-300">
              Entrá con el usuario ya registrado. Si todavía no existe, primero crealo.
            </p>
          </div>
